...
function draw() {
  ...
  // once there's 30 balls, all disappear
  if (agents.length >= 30) {
    agents = [];
  }
...
class Agent {
  constructor(x, y, sz, speedX, speedY) {
    ...
    // Lifespan (optional)
    this.life = random(300,900); // use this if you want fade/shrink/remove behavior
  }
  ...
  show() {
    ...
    fill(50 + (this.h % 200), (this.h % 20), 100 + (this.h % 2), this.a);
